...
对于方程$(1)$，当满足以下的约束条件时
\begin{align}
  & a_{1}(t) = \pm\frac{1}{2}\sqrt{1-12\delta}a_{3}(t) \\
  & a_{2}(t) = \pm\sqrt{1-12\delta}a_{3}(t) \\
  & a_{4}(t) = 6a_{3}(t) \\
  & a_{5}(t) = -3a_{3}(t) \\
  & a_{6}(t) = \gamma a_{3}(t) \\
  & a_{7}(t) = \delta a_{3}(t)
...
并且
\begin{align}
& k=e^{\left[\mathrm{i}\left(\pm \frac{1}{6}\sqrt{1-12\delta}x + \frac{1}{108}(108\gamma \mp \sqrt{1-12\delta} \mp 6\sqrt{1-12\delta}\delta)\int a_{3}(t)dt\right)\right]} \\
& b(t) = a_{3}(t)
\end{align}
使得
\begin{equation}
